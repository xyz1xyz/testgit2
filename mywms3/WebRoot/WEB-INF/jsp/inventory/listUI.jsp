...
<head>
    ...
    <script type="text/javascript">
      	...
      	var list_url = "${basePath}inventory/inventory_listUI.action";
    	//搜索
      	function doSearch(){
      		//重置页号
      		$("#pageNo").val(1);
        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
                    <li>
                          仓库名：<s:textfield name="inventory.storageName" cssClass="s_text"   cssStyle="width:160px;"/>
                         
                         货物名：<s:textfield name="inventory.materialName" cssClass="s_text"   cssStyle="width:160px;"/>
                    </li>
