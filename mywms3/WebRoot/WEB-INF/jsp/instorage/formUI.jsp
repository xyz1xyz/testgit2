    ...
    <script type="text/javascript">
    	...
    	//查看明细
      	function doCheck(id){
      		...
      		var list_detailurl="${basePath}instorage/form_formDetailUI.action?formId="+id;
    ...
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
                <div class="c_crumbs"><div><b></b><strong> 单据查看</strong></div> </div>
                <div class="search_art">
                  <li>
                          单据编号：<s:textfield name="form.id" cssClass="s_text"   cssStyle="width:200px;"/>
                    </li>
                    <li>
                          入库仓库：<s:textfield name="form.inStorage" cssClass="s_text"   cssStyle="width:80px;"/>
                    </li>
                     <li>
                    ...
                    <table width="100%" border="0">
                        <tr class="t_tit">
                           <td width="140" align="center">单据编号</td>
                            ...
                            <td width="80" align="center">入库仓库</td>
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr <s:if test="#st.odd">bgcolor="f8f8f8"</s:if> >
                               ...
                               <td align="center"><s:property value="id"/></td>
                                ...
                                <td align="center"><s:property value="inStorage"/></td>
