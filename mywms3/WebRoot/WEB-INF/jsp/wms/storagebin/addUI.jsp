...
<form id="form" name="form" action="${basePath }wms/storagebin_add.action" method="post" >
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
    <div class="c_crumbs"><div><b></b><strong> 仓位管理</strong>&nbsp;-&nbsp;新增仓位</div></div>
    <div class="tableH2">新增仓位</div>
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
       
         <tr>
            <td class="tdBg" width="200px">仓位名：</td>
            <td><s:textfield id="name" name="storageBin.name"/> </td>
         </tr>
         <tr>
