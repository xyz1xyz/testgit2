...
<form id="form" name="form" action="${basePath }wms/location_add.action" method="post" >
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
    <div class="c_crumbs"><div><b></b><strong> 地域管理</strong>&nbsp;-&nbsp;新增地点</div></div>
    <div class="tableH2">新增地点</div>
