    ...
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
                <div class="c_crumbs"><div><b></b><strong> 出库单据明细</strong></div> </div>
                    ...
                    <table width="100%" border="0">
                        <tr class="t_tit">
                          ...
                          <!--   <td width="130" align="center">所属单据</td> -->
                            ...
                            <td width="100" align="center">出库仓位</td>
                        ...
                        <s:iterator value="#formdtail" status="st">
                            <tr <s:if test="#st.odd">bgcolor="f8f8f8"</s:if> >
                              ...
                              <%--   <td align="center"><s:property value="formId"/></td> --%>
                                ...
                                <td align="center"><s:property value="outstorageBinName"/></td>
                           </tr>
                        </s:iterator>
                    </table>
                </div>
